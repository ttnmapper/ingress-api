...
func TestHandlerJson(t *testing.T) {
	...
	postbodies := []string{
		...
		`{"app_eui":"6081F98D78960B0D","decoded":{"payload":[{"channel":0,"last":true,"name":"gps","type":136,"value":{"altitude":225.34,"latitude":-33.9547,"longitude":22.4344}}],"status":"success"},"dev_eui":"6081F9DE789679C1","devaddr":"1D000048","downlink_url":"https://console.helium.com/api/v1/down/472e8c1e-c6ba-4895-9a9c-4a135f9f32df/1k104dseZqkrlYw0e-tZRVg5hTwtcvsf/370bdf17-3923-4c30-812e-fb529e439fc8","fcnt":250,"hotspots":[{"channel":0,"frequency":868.0999755859375,"hold_time":2491,"id":"11FPRwUQh6cFu6gAbBajEms7NJ8skuzLbSPetzRCZrMaCw2V3VV","lat":-33.941494818972664,"long":22.407015926933052,"name":"bent-navy-fox","reported_at":1640019676608,"rssi":-114.0,"snr":-0.800000011920929,"spreading":"SF7BW125","status":"success"}],"id":"370bdf17-3923-4c30-812e-fb529e439fc8","metadata":{"adr_allowed":false,"cf_list_enabled":false,"labels":[{"id":"5e402beb-267c-40a0-b297-549d683dff5a","name":"cayenne-trackers","organization_id":"7b684371-d8f8-4384-814a-eba3e269dc0a"}],"multi_buy":1,"organization_id":"7b684371-d8f8-4384-814a-eba3e269dc0a"},"name":"cricket-002","payload":"AIj60aUDbFgAWAY=","payload_size":11,"port":1,"raw_packet":"QB0AAEgA+gABiro2pDjmZSkGCX3B4FHv","replay":false,"reported_at":1640019676608,"type":"uplink","uuid":"95de1c82-03d1-4ab0-95a4-b0d6df779647"}`,
	}
